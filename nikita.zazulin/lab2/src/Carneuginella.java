...
public class Carneuginella extends Fish implements Eatable {
    ...
    public Carneuginella(byte size, String description, byte weight, boolean hungry, byte speed, byte fin) {
    ...
    public Carneuginella(byte size, String description, byte weight, boolean hungry, byte speed) {
