...
import static lab3.src.service.Helper.getIntInRange;
...
public class MainService {
    ...
    private static void countOfPlaintiffsWasAcquitted(List<CourtCase> courtCases) {
    ...
    private static void moreThanOneArticleInTenYears(List<CourtCase> courtCases) {
    ...
    private static void suedMoreThanOneTimeInTheLastThreeYears(List<CourtCase> courtCases) {
