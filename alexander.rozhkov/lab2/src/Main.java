...
public class Main {
    public static void main(String[] args) {
        ...
        createRecordsOfVehicle(factory, listOfVehicle);
        workWithListOfVehicle(listOfVehicle);
    }

    public static void createRecordsOfVehicle(ConstructionVehiclesFactory factory, List<ConstructionVehicle> listOfVehicle) {
        while (true) {
